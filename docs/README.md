...
- **🔨 IMPC-12.** `메서드 : inputDate`[]

  담당 기능

  🪛 **IMPC-41.** 사용자에게 메시지를 표시하고 날짜를 입력받음 []
...
- **🔨 IMPC-13.** `메서드 : isValidDate` []
  ...
  🪛 **IMPC-43.** 입력된 날짜가 1~31 사이인지 검증 []
  
  🪛 **IMPC-44.** 날짜가 빈 값일 경우(공백만 입력) 에러로 간주 []

  🪛 **IMPC-45.** 날짜에 문자가 포함되어 있는 경우 에러로 간주 []

  🪛 **IMPC-46.** 날짜에 특수 문자가 포함되어 있는 경우 에러로 간주 []

  🪛 **IMPC-47.** 날짜 입력의 에러 메세지 반환 []

<br>

- **🔨 IMPC-14.** `메서드 : dateError` []
...
**🖥️ IMPC-8.** **`클래스 : BenefitCalculator`** []
